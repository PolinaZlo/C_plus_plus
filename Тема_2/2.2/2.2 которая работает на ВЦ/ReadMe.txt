========================================================================
    КОНСОЛЬНОЕ ПРИЛОЖЕНИЕ. Обзор проекта 2.2 которая работает на ВЦ
========================================================================

Это приложение 2.2 которая работает на ВЦ создано автоматически с помощью мастера приложений.

В этом файле представлена сводка содержимого всех файлов, входящих в состав приложения 2.2 которая работает на ВЦ.


2.2 которая работает на ВЦ.vcxproj
...
2.2 которая работает на ВЦ.vcxproj.filters
...
2.2 которая работает на ВЦ.cpp
...
StdAfx.h, StdAfx.cpp
    Эти файлы используются для построения файла предкомпилированного заголовка (PCH) с именем 2.2 которая работает на ВЦ.pch и файла предкомпилированных типов с именем StdAfx.obj.
